...
export const benefitsData: Benefit[] = [
  {
    ...
    description: 'Your brain naturally remembers unfinished tasks 90% better. Tomorrow harnesses this by creating the perfect "open loops" that keep you motivated.',
    icon: <BrainIcon />,
    statistic: {
      value: 90,
      suffix: '%',
  ...
  },
  {
    ...
    description: 'Implementation intentions boost goal achievement by 65%. Tomorrow creates automatic behavioral triggers for consistent execution.',
    icon: <TargetIcon />,
    statistic: {
      value: 65,
      suffix: '%',
  ...
  },
  {
    ...
    description: 'Your brain juggles 3-5 items max. Tomorrow externalizes your mental load, freeing cognitive resources for deep work.',
    icon: <MemoryIcon />,
    statistic: {
      value: 5,
      suffix: 'x',
